	...
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<div class="container-fluid">
			<div class="navbar-btn">
				<button type="button" class="btn-toggle-fullwidth" v-on:click="toggleFullWidth">
					<i v-bind:class= "{'lnr lnr-arrow-left-circle':lnrArrowCircle,'lnr lnr-arrow-right-circle':!lnrArrowCircle}"></i>
				</button>
			</div>
